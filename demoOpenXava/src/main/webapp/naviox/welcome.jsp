...
In demoOpenXava-labels_en.properties:
demoOpenXava=My application
demoOpenXava[description]=My application does this and that

In demoOpenXava-messages_en.properties:
